    ...
    async def do_pm_permit_action(chat_id, event, sender):
        ...
        if PMMENU:
            if Config.CUSTOM_PMPERMIT_TEXT:
                ...
                USER_BOT_NO_WARN = (
                   f"`Hello `{mention}` This Is An Antispam Userbot Service⚠️.You have found your way here to my sweet master's "
                   ...
                   f"Mostly he is a busy person.. And told me to take care of his inbox..🤖\
            ...
            if Config.CUSTOM_PMPERMIT_TEXT:
                USER_BOT_NO_WARN = Config.CUSTOM_PMPERMIT_TEXT.format(
                    ...
                    USER_BOT_NO_WARN = (
                    ("`Hello `{mention}` This Is An Antispam Userbot Service⚠️.You have found your way here to my sweet master's ,`"
                   f"{DEFAULTUSER}'s inbox. He is little busy right now..so please follow the below guidelines so that he can decide the reason, why are you here and approve you**\
